...
import squareRootUsingLoop from '@/algorithm/search/square-root/loop';
import squareRootUsingBinarySearch from '@/algorithm/search/square-root/binary-search';
...
// yarn test src/algorithm/search/square-root.test.ts
