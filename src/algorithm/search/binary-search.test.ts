import iterativeBinarySearch from '@/algorithm/search/iterative-binary';
import recursiveBinarySearch from '@/algorithm/search/recursive-binary';
...
// yarn test src/algorithm/search/binary-search.test.ts
