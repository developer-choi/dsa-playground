...
import {reverseStackUsingRecursive} from '@/examples/data-structure/stack/problems/reverse';

// yarn test src/examples/data-structure/stack/problems/reverse.test.ts
