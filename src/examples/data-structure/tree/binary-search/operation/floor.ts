 ...
 * Auxiliary Space: O(h)
 */
export function recursiveFloorBST(root: BinaryTreeNode<number> | undefined, target: number): number | -1 {
  let result = -1;
 ...
 * Auxiliary Space: O(1)
 */
export function iterativeFloorBST(root: BinaryTreeNode<number> | undefined, target: number): number | -1 {
