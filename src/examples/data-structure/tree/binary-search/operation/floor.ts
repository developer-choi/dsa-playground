 ...
 * Auxiliary Space: O(h)
 */
export function recursiveFloorBST(root: BinaryTreeNode<number> | undefined, target: number): number | undefined {
 ...
 * Auxiliary Space: O(1)
 */
export function iterativeFloorBST(root: BinaryTreeNode<number> | undefined, target: number): number | undefined {
