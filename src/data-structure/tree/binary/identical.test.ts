...
import {areTreesIdenticalWithBFS, areTreesIdenticalWithDFS} from '@/data-structure/tree/binary/identical';
...
// yarn test src/data-structure/tree/binary/identical.test.ts
